...
namespace System.IO
{
    ...
    {
        internal RawFindData(Interop.NtDll.FILE_FULL_DIR_INFORMATION* info, string directory, string userDirectory = null)
        {
            _info = info;
            Directory = directory;
        ...
        private unsafe Interop.NtDll.FILE_FULL_DIR_INFORMATION* _info;
