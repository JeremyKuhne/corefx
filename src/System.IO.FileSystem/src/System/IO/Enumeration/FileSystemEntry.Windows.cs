...
namespace System.IO.Enumeration
{
    ...
    {
        internal FileSystemEntry(Interop.NtDll.FILE_FULL_DIR_INFORMATION* info, string directory, string rootDirectory, string originalRootDirectory)
        {
            _info = info;
            Directory = directory;
            RootDirectory = rootDirectory;
            OriginalRootDirectory = originalRootDirectory;
        }
