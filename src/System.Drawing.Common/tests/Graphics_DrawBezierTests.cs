    ...
    public class Graphics_DrawBezierTests
    {
        ...
        public void DrawBezier_Point()
        {
            ...
            using (Graphics graphics = Graphics.FromImage(image))
            {
                ...
                ValidateImageContent(image, new byte[] { 0xa4, 0xb9, 0x73, 0xb9, 0x6f, 0x3a, 0x85, 0x21, 0xd3, 0x65, 0x87, 0x24, 0xcf, 0x6d, 0x61, 0x94 });
            }
        }
        ...
        public void DrawBezier_Points()
        {
            ...
            using (Graphics graphics = Graphics.FromImage(image))
            {
                ...
                ValidateImageContent(image, new byte[] { 0xd0, 0x00, 0x08, 0x21, 0x06, 0x29, 0xd8, 0xab, 0x19, 0xc5, 0xc9, 0xf6, 0xf2, 0x69, 0x30, 0x1f });
            }
        }
